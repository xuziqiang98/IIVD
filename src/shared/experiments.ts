...
export const experimentConfigsMap: Record<ExperimentKey, ExperimentConfig> = {
	...
	SEARCH_AND_REPLACE: {
		...
		description:
			"Enable the experimental search and replace tool, allowing IIVD to replace multiple instances of a search term in one request.",
		enabled: false,
	},
	INSERT_BLOCK: {
		...
		description:
			"Enable the experimental insert content tool, allowing IIVD to insert content at specific line numbers without needing to create a diff.",
		enabled: false,
	},
	POWER_STEERING: {
		name: 'Use experimental "power steering" mode',
		description:
			"When enabled, IIVD will remind the model about the details of its current mode definition more frequently. This will lead to stronger adherence to role definitions and custom instructions, but will use more tokens per message.",
		enabled: false,
	},
}
